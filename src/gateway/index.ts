...
async function promptSetupMode(cfg: GatewayConfig, linkedPhone: string): Promise<void> {
  ...
  try {
    ...
    console.log('');
    console.log('How will you use AlphaSentry with WhatsApp?');
    console.log('  1) Self-chat  — message yourself to talk to AlphaSentry');
    console.log('  2) Bot phone  — this is a dedicated AlphaSentry phone, others message it');
    ...
    console.log('');
    console.log('Enter the phone number(s) allowed to message AlphaSentry (E.164 format, e.g. +15551234567).');
...
async function run(): Promise<void> {
  ...
  console.log('AlphaSentry gateway running. Press Ctrl+C to stop.');
